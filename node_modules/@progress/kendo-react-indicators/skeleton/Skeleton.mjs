...
const r = e.forwardRef((t, i) => {
  f(y);
  const { className: l, style: m } = t, n = e.useRef(null), u = e.useCallback(() => {
  ...
  const o = e.useMemo(() => t.shape || c.shape, [t.shape]), a = e.useMemo(() => t.animation === !1 ? !1 : t.animation || c.animation, [t.animation]), p = e.useMemo(
    () => k(
      "k-skeleton",
      {
  ...
  return /* @__PURE__ */ e.createElement("span", { ref: n, className: p, style: m });
});
r.propTypes = {
  className: s.string,
  style: s.object,
